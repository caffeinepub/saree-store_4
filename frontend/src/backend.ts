...
import type { Category as _Category, PartialProduct as _PartialProduct, Product as _Product, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: PartialProduct): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(to_candid_PartialProduct_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOnOfferProducts(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOnOfferProducts();
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: PartialProduct): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, to_candid_PartialProduct_n1(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        offerDetails: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.offerDetails)),
        category: from_candid_Category_n11(_uploadFile, _downloadFile, value.category),
        isOnOffer: value.isOnOffer,
        price: value.price
    };
}
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "handbag" in value ? Category.handbag : "jewelry" in value ? Category.jewelry : "saree" in value ? Category.saree : value;
}
...
function to_candid_PartialProduct_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PartialProduct): _PartialProduct {
...
function to_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        description: value.description,
        imageUrl: value.imageUrl,
        offerDetails: value.offerDetails ? candid_some(value.offerDetails) : candid_none(),
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.handbag ? {
        handbag: null
    } : value == Category.jewelry ? {
        jewelry: null
    } : value == Category.saree ? {
        saree: null
    } : value;
}
