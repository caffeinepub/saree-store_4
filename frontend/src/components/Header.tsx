          ...
          <div className="flex items-center gap-2">
            ...
            <form onSubmit={handleSearch} className="hidden sm:flex items-center">
              <div className="relative">
                ...
                />
                <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 text-teal-400 hover:text-champagne-300 transition-colors">
            ...
            >
              {loginStatus === 'logging-in' ? 'Loading...' : isAuthenticated ? 'Logout' : 'Login'}
            </Button>
        ...
        <div className="md:hidden bg-teal-900 border-t border-teal-700 px-4 py-4 space-y-1">
          ...
          <form onSubmit={handleSearch} className="mb-3">
            <div className="relative">
              ...
              />
              <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 text-teal-400">
          ...
          {isAdmin && (
            <button
              ...
              className="block w-full text-left px-3 py-2 text-sm font-sans tracking-wider uppercase rounded text-teal-100 hover:bg-teal-800 hover:text-champagne-300 transition-colors"
            >
              Admin
            </button>
          )}
