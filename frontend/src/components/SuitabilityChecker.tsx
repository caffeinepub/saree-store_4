...
function calculateSuitability(
  ...
  if (occasion === 'wedding') {
    if (name.includes('silk') || desc.includes('silk') || desc.includes('bridal')) score += 12;
    ...
    if (desc.includes('cotton') || desc.includes('linen') || desc.includes('simple')) score += 10;
...
export default function SuitabilityChecker({ product }: SuitabilityCheckerProps) {
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-display text-lg text-teal-800">Suitability Checker</h3>
      </div>
      ...
      <Button
        onClick={handleCheck}
        className="bg-teal-700 hover:bg-teal-600 text-champagne-200 font-sans tracking-widest uppercase text-sm rounded-sm border-0 w-full sm:w-auto px-8"
      >
