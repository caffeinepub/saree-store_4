      ...
      <section className="relative bg-teal-800 py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-champagne-500/20 border border-champagne-400/40 rounded-full px-4 py-1.5 mb-4">
            ...
            <span className="font-sans text-xs text-champagne-300 tracking-widest uppercase">Limited Time</span>
          </div>
          <h1 className="font-serif text-4xl md:text-5xl text-champagne-100 mb-3">Special Offers</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {isLoading ? (
            ...
            <>
              <div className="flex items-center justify-between mb-6">
                <p className="font-sans text-sm text-muted-foreground">
                  {offerProducts.length} offer{offerProducts.length !== 1 ? 's' : ''} available
                </p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div className="text-center py-20">
              ...
              <p className="font-display text-xl text-teal-700 mb-2">No offers right now</p>
