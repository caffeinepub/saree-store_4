  ...
  return (
    <main>
      ...
      <section className="relative h-56 md:h-72 overflow-hidden">
        <img
          src="/assets/generated/saree-category.dim_600x400.png"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
            ...
            <h1 className="font-serif text-4xl md:text-5xl text-champagne-100">Sarees</h1>
            <p className="font-sans text-teal-200 text-sm mt-2">Silk, Cotton, Banarasi & More</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-teal-50 border-b border-teal-100 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display text-teal-800 text-base">Not sure which saree suits you?</p>
              <p className="font-sans text-xs text-teal-500">Try our AI-powered suitability checker</p>
            </div>
          </div>
          <Dialog open={tryOnOpen} onOpenChange={setTryOnOpen}>
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="font-serif text-teal-800">Virtual Try-On</DialogTitle>
              </DialogHeader>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {isLoading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="font-display text-xl text-teal-700 mb-2">No sarees found</p>
