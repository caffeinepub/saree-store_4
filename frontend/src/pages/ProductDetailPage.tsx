...
import { ShoppingBag, ArrowLeft, Star, Tag, Package, CheckCircle } from 'lucide-react';
  ...
  if (!product) {
    return (
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <h2 className="font-serif text-2xl text-teal-800 mb-2">Product not found</h2>
        <Button
          onClick={() => navigate({ to: '/' })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white rounded-xl p-6 shadow-sm border border-teal-50">
          ...
          <div className="flex flex-col">
            <h1 className="font-serif text-3xl md:text-4xl text-teal-800 mb-2">{product.name}</h1>
            ...
            <div className="flex items-center gap-2 mb-6">
              {inStock ? (
                ...
                <>
                  ...
                  <span className="text-sm font-sans text-destructive">Out of Stock</span>
                </>
              )}
            </div>
