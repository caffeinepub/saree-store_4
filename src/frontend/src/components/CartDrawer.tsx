        ...
        <div className="flex-1 overflow-y-auto py-4 space-y-4">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              ...
              <p className="font-display text-lg text-teal-700">
                Your cart is empty
              </p>
            ...
            items.map((item) => (
              <div
                ...
                className="flex gap-3 bg-white rounded-lg p-3 border border-teal-100 shadow-sm"
              >
                {/* Image */}
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-display text-sm text-teal-800 line-clamp-2">
                    {item.product.name}
                  </h4>
