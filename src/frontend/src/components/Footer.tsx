...
export default function Footer() {
  ...
  const appId = encodeURIComponent(
    window.location.hostname || "dalis-boutique",
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-xl text-champagne-200 tracking-wide">
                Dali's Boutique
              </span>
            </div>
            <p className="text-sm text-teal-300 leading-relaxed font-sans">
              Curating timeless elegance through handpicked sarees, jewelry, and
          ...
          {/* Shop */}
          <div>
            <h4 className="font-display text-champagne-300 text-lg mb-4 tracking-wide">
              Shop
            </h4>
      ...
      <div className="border-t border-teal-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs text-teal-500 hover:text-champagne-400 transition-colors font-sans"
          >
            <ShieldCheck className="w-3 h-3" /> Owner Admin
          </button>
          <p className="text-xs text-teal-400 font-sans flex items-center gap-1">
            Built with{" "}
            <Heart className="w-3 h-3 text-champagne-400 fill-champagne-400" />{" "}
            using{" "}
            <a
