...
import jewelryBannerImg from "/assets/generated/jewelry-category.dim_600x400.jpg";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display text-teal-800 text-base">
                Not sure which jewelry suits you?
              </p>
              <p className="font-sans text-xs text-teal-500">
                Upload your photo and check suitability
              </p>
            </div>
          </div>
          <Dialog open={tryOnOpen} onOpenChange={setTryOnOpen}>
            <DialogTrigger asChild>
              <Button
                data-ocid="jewelry.tryon.open_modal_button"
              ...
              >
                Try On <ArrowRight className="w-3.5 h-3.5 ml-1.5" />
              </Button>
            </DialogTrigger>
